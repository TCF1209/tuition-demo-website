        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-3">
          ...
          <div>
            ...
            <div className="mt-4 flex gap-3">
              <a
                href="https://www.facebook.com/mhlearningcentre"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-gray-400 transition-colors hover:bg-[#1877F2] hover:text-white"
              >
              ...
              <a
                href="https://www.instagram.com/mhlearningcentre/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram"
                className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-gray-400 transition-colors hover:bg-[#E4405F] hover:text-white"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
