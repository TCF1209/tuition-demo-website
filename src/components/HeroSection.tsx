...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center bg-dark-bg grain-overlay overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              variants={fadeUp}
              className="font-heading text-xl text-primary-teal/80"
            >
              Where Results Begin
            </motion.p>
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap gap-4 mt-2">
              <a
                ...
                className="inline-flex items-center justify-center bg-primary-teal text-white font-heading font-semibold rounded-lg px-8 py-4 text-lg transition-all duration-300 hover:shadow-[0_0_24px_rgba(42,191,170,0.5)] hover:scale-105"
              >
                📲 WhatsApp 立即咨询
              </a>
              <Link
                href="/courses"
                className="inline-flex items-center justify-center border border-white/30 text-white font-heading font-semibold rounded-lg px-8 py-4 text-lg transition-all duration-300 hover:border-white/60 hover:bg-white/5"
              >
                了解课程 →
              </Link>
            </motion.div>
          ...
          >
            <div className="relative w-72 h-72 sm:w-96 sm:h-96">
              ...
              {/* Hexagon-like decorative element */}
              <svg
