...
export function HeroSection() {
  return (
    <section className="relative flex items-start lg:items-center bg-dark-bg grain-overlay overflow-hidden lg:min-h-screen">
      ...
      {/* Main content */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-28 pb-20 lg:py-20">
        <motion.div
